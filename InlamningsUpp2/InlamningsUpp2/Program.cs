...
namespace ConsoleApplication1
{
    class Program
    {
        ...
        {
            Console.WriteLine("Välj ett alternativ: 1) InsertCustomer 2) InsertProduct 3) UpdateProductPrice");
            ...
            switch (Inmatat)
            {
                ...
                case "2":
                    ...
                    //InsertProduct();
                    Console.WriteLine("Mata in följande i samma utförande: ProductName, SupplierID(1-29), CategoryID,\nQuantityPerUnit, UnitPrice, UnitsInStock, UnitsOnOrder, ReorderLevel, Discountinued");
                ...
                default:
                    Console.WriteLine("Felaktig inmatning, välj mellan 1-3");
                    break;
            }
        }
    }
